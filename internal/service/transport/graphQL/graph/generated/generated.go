...
type ComplexityRoot struct {
	Item struct {
		...
		ItemsNumber func(childComplexity int) int
		Name        func(childComplexity int) int
		Price       func(childComplexity int) int
	}

	Mutation struct {
		AddItem      func(childComplexity int, item model.Iteminput) int
		DeletePerson func(childComplexity int, id string) int
		UpdatePerson func(childComplexity int, id string) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Item.itemsNumber":
		if e.complexity.Item.ItemsNumber == nil {
			break
		}

		return e.complexity.Item.ItemsNumber(childComplexity), true
	...
	case "Mutation.addItem":
		...
		return e.complexity.Mutation.AddItem(childComplexity, args["item"].(model.Iteminput)), true
	...
	case "Mutation.updatePerson":
		...
		return e.complexity.Mutation.UpdatePerson(childComplexity, args["id"].(string)), true
...
func (ec *executionContext) _Item_itemsNumber(ctx context.Context, field graphql.CollectedField, obj *model.Item) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_addItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddItem(rctx, args["item"].(model.Iteminput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updatePerson(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdatePerson(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputIteminput(ctx context.Context, obj interface{}) (model.Iteminput, error) {
	...
	for k, v := range asMap {
		...
		case "itemsNumber":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("itemsNumber"))
			it.ItemsNumber, err = ec.unmarshalNInt2int(ctx, v)
			if err != nil {
				return it, err
			}
		case "desc":
...
func (ec *executionContext) _Item(ctx context.Context, sel ast.SelectionSet, obj *model.Item) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "itemsNumber":
			out.Values[i] = ec._Item_itemsNumber(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "desc":
